(() => {
    ...
    function initSliders() {
        if (document.querySelector(".hosts__slider")) new swiper_core_Swiper(".hosts__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".hosts__arrow.swiper-button-prev",
                nextEl: ".hosts__arrow.swiper-button-next"
            },
            on: {}
        });
    }
